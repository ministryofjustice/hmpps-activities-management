...
context('Daily Attendance', () => {
  ...
  it('should click through create activity journey', () => {
    ...
    activitiesPage.assertRow(1, true, 'English level 1', 'Education 2', '09:00 to 10:00', '4', '2', '1', '1')
    activitiesPage.assertRow(2, true, 'English level 2', 'Education 1', '09:00 to 10:00', '7', '5', '2', '1')
    activitiesPage.assertRow(3, false, 'Football', 'Off wing', '09:00 to 09:45', '16', '-', '-', '-')
    activitiesPage.assertRow(4, false, 'Gym', 'Gym', '14:30 to 17:00', '8', '-', '-', '-')
    activitiesPage.assertRow(5, true, 'Maths level 1', 'B wing', '09:20 to 10:20', '16', '14', '2', '0')
    ...
    activitiesPage.assertRow(2, true, 'English level 2', 'Education 1', '09:00 to 10:00', '7', '5', '2', '1')
    activitiesPage.assertRow(3, false, 'Football', 'Off wing', '09:00 to 09:45', '16', '-', '-', '-')
    activitiesPage.assertRow(4, true, 'Maths level 1', 'B wing', '09:20 to 10:20', '16', '14', '2', '0')
  })
