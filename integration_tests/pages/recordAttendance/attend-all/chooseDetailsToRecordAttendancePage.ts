...
export default class ChooseDetailsToRecordAttendancePage extends Page {
  ...
  radioTodayClick = (): Cypress.Chainable => cy.get('#attendanceDate').click()

  radioTomorrowClick = (): Cypress.Chainable => cy.get('#attendanceDate-2').click()

  radioOtherClick = (): Cypress.Chainable => cy.get('attendanceDate-3').click()
