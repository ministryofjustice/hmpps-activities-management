import { calculateEndDate } from './end-date.js'
...
describe('Appointment end date', () => {
  describe('Weekday', () => {
    it.each([
      ...
      [
        '2 appointments, starts Saturday, skips Sunday',
        new Date('2023-04-22 00:00:00'),
        2,
        new Date('2023-04-24 00:00:00'),
      ],
      ...
      [
        '7 appointments, starts Saturday, skips Sunday and weekend',
        new Date('2023-04-22 00:00:00'),
        7,
      ...
      [
        '6 appointments, Monday - Monday, skips weekend',
        new Date('2023-04-24 00:00:00'),
        6,
        new Date('2023-05-01 00:00:00'),
      ],
  ...
  describe('Daily', () => {
    it.each([
      ['1 appointment, starts Saturday', new Date('2023-04-22 00:00:00'), 1, new Date('2023-04-22 00:00:00')],
      [
        '2 appointments, starts Saturday, ends Sunday',
        new Date('2023-04-22 00:00:00'),
        2,
        new Date('2023-04-23 00:00:00'),
      ],
  ...
  describe('Monthly', () => {
    it.each([
      ...
      [
        '3 appointments, invalid end date (30 Feb)',
        new Date('2024-12-30 00:00:00'),
        3,
        new Date('2025-02-28 00:00:00'),
      ],
      [
        '3 appointments, invalid end date (30 Feb), leap year',
        new Date('2023-12-30 00:00:00'),
        3,
