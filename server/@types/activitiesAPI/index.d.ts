    ...
    getAttendanceForSuspendedPrisoners: {
        parameters: {
            query: {
                ...
                date: string;
                reason?: string;
                categories?: ("SAA_EDUCATION" | "SAA_INDUSTRIES" | "SAA_PRISON_JOBS" | "SAA_GYM_SPORTS_FITNESS" | "SAA_INDUCTION" | "SAA_INTERVENTIONS" | "SAA_FAITH_SPIRITUALITY" | "SAA_NOT_IN_WORKSAA_OTHER")[];
            };
            header?: never;
            path: {
                /** @description The 3-character prison code. */
