...
export interface components {
  schemas: {
    ...
    Location: {
      ...
      /**
       * @description Converted Cell Types
       * @enum {string}
       */
      convertedCellType?:
        | 'HOLDING_ROOM'
    ...
    ConvertToCellRequest: {
      /**
       * @description Allowable Accommodation Types
    ...
    ReactivateLocationsRequest: {
       ...
       */
      locations: {
        [key: string]: components['schemas']['ReactivationDetail'] | undefined
      }
    }
    /**
    ...
    DeactivateLocationsRequest: {
       ...
       */
      locations: {
        [key: string]: components['schemas']['TemporaryDeactivationLocationRequest'] | undefined
      }
    }
    ...
    UpdateCapacityRequest: {
       ...
       */
      locations: {
        [key: string]: components['schemas']['CellCapacityUpdateDetail'] | undefined
      }
    }
    ...
    ResidentialLocationRollCount: {
      ...
      subLocations?: components['schemas']['ResidentialLocationRollCount'][]
    }
  ...
  bulkUpdateCapacity: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json': {
            [key: string]: components['schemas']['CapacityChanges'][] | undefined
          }
        }
      }
      /** @description Invalid Request */
  ...
  getCellsWithCapacity: {
    parameters: {
      query?: {
         ...
         * @example CSU
         */
        specialistCellType?: string
        /** @description Include prisoner details in this cell */
        includePrisonerInformation?: string
      }
      header?: never
      path: {
        /**
  ...
  residentialAttributeTypeConstants: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json': {
            [key: string]: components['schemas']['CompoundConstant'][] | undefined
          }
        }
      }
      /** @description Unauthorized to access this endpoint */
