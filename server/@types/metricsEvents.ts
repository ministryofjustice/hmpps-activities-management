...
export enum MetricsEventType {
  ...
  CREATE_OUTSIDE_ACTIVITY_JOURNEY_STARTED = 'SAA-Create-Outside-Activity-Journey-Started',
  CREATE_OUTSIDE_ACTIVITY_JOURNEY_COMPLETED = 'SAA-Create-Outside-Activity-Journey-Completed',
