...
export enum MetricsEventType {
  ...
  CREATE_OUTSIDE_ACTIVITY_JOURNEY_STARTED = 'SAA-Create-External-Activity-Journey-Started',
  CREATE_OUTSIDE_ACTIVITY_JOURNEY_COMPLETED = 'SAA-Create-External-Activity-Journey-Completed',
  CREATE_ALLOCATION_JOURNEY_STARTED = 'SAA-Create-Allocation-Journey-Started',
  CREATE_OUTSIDE_ALLOCATION_JOURNEY_STARTED = 'SAA-Create-Outside-Allocation-Journey-Started',
  ...
  CREATE_OUTSIDE_ALLOCATION_JOURNEY_COMPLETED = 'SAA-Create-Outside-Allocation-Journey-Completed',
  CREATE_MULTIPLE_ALLOCATION_JOURNEY_COMPLETED = 'SAA-Create-Multiple-Allocation-Journey-Completed',
