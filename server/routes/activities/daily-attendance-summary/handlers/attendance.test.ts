...
//   //     expect(attendanceSummaryJourney.categoryFilters[0].value).toEqual('Education')
//   //     expect(attendanceSummaryJourney.categoryFilters[0].text).toEqual('Education')
//   //     expect(attendanceSummaryJourney.categoryFilters[0].checked).toEqual(true)
//   //
//   //     expect(res.redirect).toHaveBeenCalledWith(
//   //       `attendance?date=${formatDate(attendanceSummaryJourney.activityDate, 'yyyy-MM-dd')}&status=NotAttended`,
//   //     )
//   //   })
//   // })
//   //
