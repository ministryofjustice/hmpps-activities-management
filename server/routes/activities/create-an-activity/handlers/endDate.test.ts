  ...
  describe('POST', () => {
    ...
    it('should save entered end date in database', async () => {
      ...
      expect(res.redirectWithSuccess).toHaveBeenCalledWith(
        '/activities/view/1',
        'Activity updated',
        "We've updated the end date for Maths level 1. Anyone allocated to the activity who was due to be taken off after this date will now finish on this date.",
      )
    })
  })
