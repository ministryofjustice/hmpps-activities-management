...
export default class QualificationRoutes {
  GET = async (req: Request, res: Response): Promise<void> => {
    res.render(`pages/appointments/create/repeat-period-and-count`)
  }
  ...
  POST = async (req: Request, res: Response): Promise<void> => {
    ...
    req.session.createAppointmentJourney.repeatPeriod = repeatPeriod
    req.session.createAppointmentJourney.repeatCount = repeatCount
