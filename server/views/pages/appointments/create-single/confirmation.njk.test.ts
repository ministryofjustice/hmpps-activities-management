...
const view = fs.readFileSync('server/views/pages/appointments/create-single/confirmation.njk')
...
describe('Views - Create Individual Appointment - Check Answers', () => {
  ...
  it('should not display repeat frequency or occurrences when repeat = NO', () => {
    viewContext.session.createSingleAppointmentJourney = {
      prisoner: {
        name: 'TEST PRISONER',
        number: 'A1234BC',
        cellLocation: '1-2-3',
      ...
      repeat: YesNo.NO,
    } as CreateSingleAppointmentJourney
