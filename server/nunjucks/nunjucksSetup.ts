...
import { AbsencePayFilter, EventSource, EventType, YesNo } from '../@types/activities'
...
export function registerNunjucks(applicationInfo?: ApplicationInfo, app?: express.Express): Environment {
  ...
  njkEnv.addGlobal('AbsencePayFilter', AbsencePayFilter)
  ...
  njkEnv.addGlobal('videoConferenceRoomAvailabilityPrisons', config.videoConferenceRoomAvailabilityPrisons)
  njkEnv.addGlobal('showVideoCourtHearingMovementSlip', config.showVideoCourtHearingMovementSlip)
