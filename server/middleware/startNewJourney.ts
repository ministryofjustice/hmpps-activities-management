...
export default function startNewJourney(replaceUrl: string) {
  return (req: Request, res: Response): void => {
    // This code generates and inserts a journeyId uuid/guid into the original URL. As all subsequent redirects are
    // relative, this journeyId remains in the URL for the complete journey allowing it to be associated with
