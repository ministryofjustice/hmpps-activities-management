...
test('a user can log a pending waitlist application', async ({ page }) => {
  ...
  await expectPage(page, /You've successfully logged David Winchurch's application for Maths level 1/i, true)
